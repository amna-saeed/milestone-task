     ...
     <div className="flex min-h-screen bg-white">
        <div className="flex w-full md:w-1/2 items-center justify-center px-6 sm:px-12 lg:px-20">
          <div className="w-full max-w-md bg-gray-50 shadow-md rounded-2xl border border-[#e5e5e5] p-8">
              <h2 className="heading-lg sm:text-2xl font-semibold text-center mb-4 sm:mb-6 text-[#184071]">Register</h2>
                ...
                <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
                  ...
                  <div className="mb-4">
                    <button 
                      type="submit" 
                      disabled={loading}
                      className="w-full p-2 bg-[#184071] text-white rounded-md hover:bg-[#286eb9] disabled:opacity-50 disabled:cursor-not-allowed"
                    >
        ...
        <div className="hidden md:flex w-1/2 items-center justify-center relative">
            ...
            <div className="absolute text-center text-white px-6">
              ...
              <p className="text-gray-200">Join us and start your journey today!</p>
            </div>
        </div>
     </div>
    </>
